...
class ParticleSystem:
    ...
    def add_explosion(self, x, y, count=20, color=(255, 255, 255), size_range=(1, 3), speed=2.0):
...
class AnimationManager:
    ...
    def add_animation(self, name, start_value, end_value, duration, 
                      delay=0, loop=False, ease_func=None):
